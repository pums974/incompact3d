...
real(8),dimension(nx) :: fiffx, fifx,ficx,fibx,fibbx,fiz1x,fiz2x
real(8),dimension(nx,2) :: filax
real(8) :: xcoef 
...
real(8),dimension(nx,ny,nz) :: ty,uy,ry 
real(8),dimension(nx,nz)  :: sy,vy
real(8),dimension(ny) :: fiffy,fify,ficy,fiby,fibby,fiz1y,fiz2y
real(8),dimension(ny,2) :: filay
real(8) :: xcoef 
...
real(8),dimension(nz) :: fiffz,fifz,ficz,fibz,fibbz,fiz1z,fiz2z
real(8),dimension(nz,2) :: filaz
real(8) :: xcoef 
...
integer :: n ,i,j,k,l
real(8), dimension(n) :: aff,af,a,ab,abb
real(8),dimension(n,2) :: al(n,2) 
real(8) :: tiny, dum 
!*********************************************************************
